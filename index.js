...
function filterUnfundedOnly() {
    ...
    // log the array of unfunded games to see how many games are in it
...
function filterFundedOnly() {
    ...
    // log the array of funded games to see how many games are in it
...
const unfundedStr = unfundedCount > 0 
    ? `Currently, there are ${unfundedCount} unfunded games. We need your help to fund these amazing games!
` 
